...
const V2 = ({ state, showChart }) => {
  ...
  return (
    <div className="v2">
      ...
      {/* Dos mundos */}
      <div className="v2-worlds">
        <div className="v2-world v2-world-markip">
          <div className="v2-world-head">
            <div className="v2-world-icon" aria-hidden="true">
            ...
            <div>
              <div className="v2-world-kicker">Lo que pagas a Markip</div>
              <div className="v2-world-title">Honorarios profesionales</div>
            </div>
          </div>
          ...
          <div className="v2-world-includes">
            ...
            <ul className="v2-includes-list">
              {pkg.includes.slice(0, 8).map((s, i) => (
                <li key={i}>
                  <svg viewBox="0 0 20 20" fill="currentColor" className="v2-check">
        ...
        <div className="v2-world v2-world-estado">
          <div className="v2-world-head">
            <div className="v2-world-icon v2-world-icon-alt" aria-hidden="true">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M3 21h18" />
            ...
            <div>
              <div className="v2-world-kicker">Lo que va al Estado</div>
              <div className="v2-world-title">Tasas oficiales INAPI</div>
            </div>
          </div>

          <div className="v2-big-amount v2-big-amount-alt">{formatCLP(tasaInicioTotal + tasaFinalTotal)}</div>
          <div className="v2-big-sub">Dividido en 2 momentos del trámite</div>

          <div className="v2-estado-breakdown">
            <div className="v2-fase">
              <div className="v2-fase-num">1</div>
              <div className="v2-fase-body">
                <div className="v2-fase-label">Al ingresar la solicitud</div>
                <div className="v2-fase-sub">{classes} × (1 UTM + $10.000)</div>
              </div>
              <div className="v2-fase-val">{formatCLP(tasaInicioTotal)}</div>
            </div>
            <div className="v2-fase">
              <div className="v2-fase-num v2-fase-num-cond">2</div>
              <div className="v2-fase-body">
                <div className="v2-fase-label">Al ser aceptada <span className="v2-fase-tag">condicional</span></div>
                <div className="v2-fase-sub">{classes} × 2 UTM · ~6 meses después</div>
              </div>
      ...
      {/* Resumen de pagos + chart */}
      <div className="v2-summary">
        <div className="v2-pays">
          <div className="v2-pays-title">Plan de pagos</div>
          <div className="v2-pay-row v2-pay-row-now">
            <div className="v2-pay-bullet">●</div>
            <div className="v2-pay-body">
              <div className="v2-pay-when">Hoy · primer pago</div>
              <div className="v2-pay-detail">Honorarios + tasa de ingreso</div>
            </div>
            <div className="v2-pay-amount">{formatCLP(primerPago)}</div>
          </div>
          <div className="v2-pay-connector" />
          <div className="v2-pay-row">
            <div className="v2-pay-bullet v2-pay-bullet-future">○</div>
            <div className="v2-pay-body">
              <div className="v2-pay-when">En ~6 meses · segundo pago</div>
              <div className="v2-pay-detail">Solo si la marca es aceptada</div>
            </div>
            <div className="v2-pay-amount v2-pay-amount-muted">{formatCLP(segundoPago)}</div>
          </div>
          <div className="v2-pays-total">
        ...
        {showChart && (
          <div className="v2-chart">
            <svg viewBox="0 0 200 200" className="v2-donut">
              <circle cx="100" cy="100" r="70" fill="none" stroke="var(--purple-600)" strokeWidth="40" strokeDasharray={`${pctMarkip * 4.4} ${440}`} transform="rotate(-90 100 100)" />
              <circle cx="100" cy="100" r="70" fill="none" stroke="var(--teal-400)" strokeWidth="40" strokeDasharray={`${pctEstado * 4.4} ${440}`} strokeDashoffset={`${-pctMarkip * 4.4}`} transform="rotate(-90 100 100)" />
              <text x="100" y="94" textAnchor="middle" className="v2-donut-val">{formatCLP(total).replace('$', '$ ')}</text>
              <text x="100" y="114" textAnchor="middle" className="v2-donut-label">total</text>
            </svg>
            <div className="v2-chart-legend">
              <div className="v2-legend-item">
                <span className="v2-legend-dot v2-legend-markip" />
                <div>
                  <div className="v2-legend-name">Markip</div>
                  <div className="v2-legend-pct">{pctMarkip.toFixed(0)}%</div>
                </div>
              </div>
              <div className="v2-legend-item">
                <span className="v2-legend-dot v2-legend-estado" />
                <div>
                  <div className="v2-legend-name">Estado (INAPI)</div>
                  <div className="v2-legend-pct">{pctEstado.toFixed(0)}%</div>
                </div>
              </div>
            </div>
          </div>
